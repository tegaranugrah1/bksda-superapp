...
export default function StockInPage() {
    ...
    return (
        <div className="p-6 md:p-10 max-w-4xl mx-auto animate-in slide-in-from-bottom-4 duration-500">
            ...
            {isSuccess && (
                <div className="mb-6 p-4 bg-orange-500/10 border border-orange-500/30 rounded-2xl flex items-center gap-3 text-orange-400 animate-in fade-in zoom-in duration-300">

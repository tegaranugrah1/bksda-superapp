      ...
      <aside className="hidden md:flex flex-col w-64 bg-white dark:bg-zinc-950 border-r border-zinc-200 dark:border-zinc-800/50">
        ...
        <div className="p-4 border-b border-zinc-200 dark:border-zinc-800/50">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="font-bold text-lg text-zinc-900 dark:text-white">Kepegawaian</h2>
              <p className="text-[10px] text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">SDM & Employee</p>
            </div>
          </div>
          <ModuleSwitcher />
        </div>

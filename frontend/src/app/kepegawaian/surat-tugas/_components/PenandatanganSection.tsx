  ...
  return (
    <FormSection title="Penandatangan">
      ...
      <input
        ...
        className="w-full px-3 py-2 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl text-sm mb-2 outline-none text-zinc-900 dark:text-white disabled:opacity-60 disabled:cursor-not-allowed"
      />
      <input
        ...
        className="w-full px-3 py-2 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl text-sm outline-none text-zinc-900 dark:text-white disabled:opacity-60 disabled:cursor-not-allowed"
      />
    </FormSection>
  );
}

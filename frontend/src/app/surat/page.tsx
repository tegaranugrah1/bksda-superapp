...
export default function SuratHubPage() {
      ...
      try {
        ...
        if (Array.isArray(apiData) && apiData.length > 0) {
          apiData.forEach((apiItem: any) => {
            if (!combinedMasuk.some((item) => String(item.no_agenda) === String(apiItem.no_agenda))) {
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      iconStyle: "bg-gradient-to-br from-teal-500 to-emerald-600 text-white shadow-teal-500/20",
    },
    {
    ...
    <div className="p-4 md:p-6 space-y-5 max-w-[1600px] mx-auto text-zinc-900 dark:text-zinc-100 font-sans">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        <div className="relative overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-4 rounded-2xl shadow-xs hover:shadow-md hover:border-emerald-500/40 transition-all group flex flex-col justify-between">
          ...
          <div className="mt-3">
            <div className="flex items-baseline gap-2">
              <p className="text-2xl md:text-3xl font-black text-zinc-900 dark:text-white tracking-tight">{totalSuratMasuk}</p>
              <span className="text-[10px] font-extrabold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950 px-1.5 py-0.5 rounded-md">Agenda Aktif</span>
            </div>
            <p className="text-[10.5px] text-zinc-500 dark:text-zinc-400 font-semibold truncate mt-0.5">Disposisi & Teragendakan</p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-4 rounded-2xl shadow-xs hover:shadow-md hover:border-blue-500/40 transition-all group flex flex-col justify-between">
          ...
          <div className="mt-3">
            <div className="flex items-baseline gap-2">
              <p className="text-2xl md:text-3xl font-black text-zinc-900 dark:text-white tracking-tight">{totalSuratKeluar}</p>
              <span className="text-[10px] font-extrabold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950 px-1.5 py-0.5 rounded-md">Terarsip</span>
            </div>
            <p className="text-[10.5px] text-zinc-500 dark:text-zinc-400 font-semibold truncate mt-0.5">Penomoran Naskah Resmi</p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-4 rounded-2xl shadow-xs hover:shadow-md hover:border-amber-500/40 transition-all group flex flex-col justify-between">
          ...
          <div className="mt-3">
            <div className="flex items-baseline gap-2">
              <p className="text-xl md:text-2xl font-black text-zinc-900 dark:text-white tracking-tight">2-Up Letter</p>
              <span className="text-[10px] font-extrabold text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950 px-1.5 py-0.5 rounded-md">Standar</span>
            </div>
            <p className="text-[10.5px] text-zinc-500 dark:text-zinc-400 font-semibold truncate mt-0.5">2 Lembar Disposisi per Halaman</p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-4 rounded-2xl shadow-xs hover:shadow-md hover:border-teal-500/40 transition-all group flex flex-col justify-between">
          ...
          <div className="mt-3">
            <div className="flex items-baseline gap-2">
              <p className="text-2xl md:text-3xl font-black text-zinc-900 dark:text-white tracking-tight">100%</p>
              <span className="text-[10px] font-extrabold text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-950 px-1.5 py-0.5 rounded-md">Terdata</span>
            </div>
            <p className="text-[10.5px] text-zinc-500 dark:text-zinc-400 font-semibold truncate mt-0.5">Penatausahaan Naskah Resmi</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-5 rounded-2xl shadow-xs flex flex-col">
          <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800/80 mb-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="font-extrabold text-xs md:text-sm text-zinc-900 dark:text-white">Surat Masuk Terbaru</h3>
                <p className="text-[10px] text-zinc-400">Naskah dinas masuk & lembar disposisi</p>
              </div>
            </div>
            <Link href="/surat/masuk" className="text-[11px] font-extrabold text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 flex items-center gap-0.5">
        ...
        <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-5 rounded-2xl shadow-xs flex flex-col">
          <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800/80 mb-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="font-extrabold text-xs md:text-sm text-zinc-900 dark:text-white">Surat Keluar Terbaru</h3>
                <p className="text-[10px] text-zinc-400">Pengagendaan naskah dinas keluar</p>
              </div>
            </div>
            <Link href="/surat/keluar" className="text-[11px] font-extrabold text-blue-600 hover:text-blue-500 dark:text-blue-400 flex items-center gap-0.5">
              <span>Lihat Semua</span>
              <ChevronRight className="w-3.5 h-3.5" />
            </Link>
          </div>

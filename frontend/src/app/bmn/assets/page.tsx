      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight flex items-center gap-3">
            <CarFront className="w-8 h-8 text-emerald-500" /> Katalog Master
            Aset
          </h1>
          <p className="text-zinc-400 mt-2 text-sm">
            Pusat kontrol wujud fisik dan nilai finansial seluruh Barang Milik
            Negara.
          </p>
        </div>
      ...
      <div className="bg-zinc-950/50 border border-zinc-800/80 rounded-2xl overflow-hidden shadow-2xl relative backdrop-blur-sm">
                  ...
                  >
                    <td className="p-4">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <span className="text-[10px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded font-mono uppercase border border-zinc-700">
                          NUP
                        </span>
                    ...
                    <td className="p-4">
                      ...
                      <p className="text-xs text-zinc-500 truncate">
                        {asset.merk_tipe || "Tanpa Merk"} &bull;{" "}
                        {asset.tahun_perolehan}
                      </p>
                    </td>
                    <td className="p-4">
                      <p className="font-black text-sm text-zinc-200">
                        {formatRupiah(asset.nilai_perolehan)}
                      </p>
                      <span
                        className={`inline-flex items-center mt-1 px-2 py-0.5 rounded text-[10px] font-bold border ${
                          asset.kondisi === "Baik"
                      ...
                      {asset.penanggung_jawab ? (
                        <div className="flex items-center gap-2 text-xs text-blue-400 bg-blue-500/10 px-2 py-1 rounded w-fit border border-blue-500/20">
                          ...
                          <span className="font-semibold">
                            {asset.penanggung_jawab.nama_lengkap}
                          </span>
                        </div>
                      ) : (
                        <div className="text-[10px] text-zinc-600 italic">
                          Tersedia / Tidak dipinjam
                        </div>
                      )}
                    </td>
                    <td className="p-4 text-center">
                      <div className="flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          className="p-2 bg-blue-500/20 hover:bg-blue-500/40 text-blue-400 rounded-lg transition-colors border border-blue-500/20"
                          title="Edit"
                        >
                          <Pencil className="w-4 h-4" />
                        </button>
                        <button
                          className="p-2 bg-red-500/20 hover:bg-red-500/40 text-red-400 rounded-lg transition-colors border border-red-500/20"
                          title="Pemutihan"
                        >
        ...
        <div className="p-4 bg-zinc-950 border-t border-zinc-800/80 flex items-center justify-between text-sm">
          <span className="text-zinc-500 font-medium">
            Menampilkan {response?.data?.length || 0} entitas
          </span>
